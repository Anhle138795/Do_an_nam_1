        ...
        <div class="carousel-item {{ $key == 0 ? 'active':'' }}">
            ...
            <div class="carousel-caption d-none d-md-block">
                <div class="custom-carousel-content">
                    ...
                    <div>
                        <button class="getnow" type="button"><a href="{{ url('/contact') }}"></a>
                    ...
                    <div class="mask">
                        <div class="d-flex justify-content-center align-items-center h-100">
                            <div class="text-white">
                                <h1 class="mb-3">SHOPLED</h1>
                                <h4 class="mb-3" style='color: black'>
                                    Chào mừng bạn đến với trang web bán hàng bóng đèn của chúng tôi.
                                    Chúng tôi cung cấp các loại bóng đèn chất lượng cao, tiết kiệm điện và thân thiện với môi trường.
                                    Bạn có thể tìm kiếm, so sánh và đặt mua các sản phẩm bóng đèn phù hợp với nhu cầu của bạn.
                                    Hãy liên hệ với chúng tôi nếu bạn có bất kỳ câu hỏi hay yêu cầu nào.
                                    Cảm ơn bạn đã ghé thăm trang web của chúng tôi.
                                </h4>
                                <a class="btn btn-outline-light btn-lg" href="#!" role="button">Shop Now</a>
                            </div>
                        </div>
                    </div>
                </div>
